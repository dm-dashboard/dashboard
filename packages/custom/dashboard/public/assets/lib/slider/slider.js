 ...
 *
 *  Heavily modified for use in the dahboard admin by Duane McKibbin
 */
...
(function($) {
    ...
    $.widget('ui.slider', $.ui.mouse, {
        ...
        refreshRanges : function(ranges){
             this.options.handles = ranges;                   
        },

        setNewMax : function(newValue){
            ...
            if (numOptions) {
                ...
                this.handles.each(function(i, j) {
                    ...
                    if (o.tooltips && i > 0) {
                        ...
                        var thisValue = allHandles.eq(i).attr('data-value');
                        var previousValue = allHandles.eq(i-1).attr('data-value');
                        var sectionValue = Math.round((thisValue - previousValue) *100)/100;
                        text += ' ' + (i) + ' : ' + sectionValue+ ' seconds';

                        $('.ui-slider-tooltip', this).text(text);
                    
                    } else {
                        $('.ui-slider-tooltip', this).hide();
                    }
                });
